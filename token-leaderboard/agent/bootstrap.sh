...
#     COLLECTOR_URL=https://tok-collector.internal COLLECTOR_TOKEN=xxx \
...
PLIST="$HOME/Library/LaunchAgents/com.eggyrooch.tokreport.plist"
UID_NUM=$(id -u)
...
<plist version="1.0"><dict>
  <key>Label</key><string>com.eggyrooch.tokreport</string>
