...
# 例:
#   ./package_mdm.sh ./tokscale https://tok-collector.internal xxxxx ./dist
set -euo pipefail
...
cp "$HERE/tokreport.py" "$HERE/identity.py" "$HERE/install.sh" "$HERE/com.eggyrooch.tokreport.plist" "$OUT/"
